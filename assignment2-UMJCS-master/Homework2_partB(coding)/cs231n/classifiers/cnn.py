...
#         affine_out, affine_cache = affine_relu_forward(pool_out, W2, b2)        
        out1, fc_cache = affine_forward(pool_out, W2, b2)
        affine_out, relu_cache = relu_forward(out1)
        ...
        loss = 0.5 * (reg * np.sum(np.square(W1)) + reg * np.sum(np.square(W2)) + reg * np.sum(np.square(W3))) + loss
        grads['W1'] += reg * W1
        grads['W2'] += reg * W2
        grads['W3'] += reg * W3
        ############################################################################
